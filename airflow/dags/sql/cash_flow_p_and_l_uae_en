DROP MATERIALIZED VIEW IF EXISTS models.cash_flow_p_and_l_uae_en;
  CREATE MATERIALIZED VIEW models.cash_flow_p_and_l_uae_en AS
    ...
    SELECT
      ...
      id_grp_payment_type,
      'Cash' AS "Метрика",
      "Cash"::double precision AS "Значение",
      1.2 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      id_grp_payment_type,
      'POS' AS "Метрика",
      "POS"::double precision AS "Значение",
      1.3 AS "POS"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Online (APP)"::double precision AS "Значение",
      1.4 AS "Online (APP)"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Gift cards (Revenue)"::double precision AS "Значение",
      1.51 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Event (revenue)"::double precision AS "Значение",
      1.52 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Other (revenue)"::double precision AS "Значение",
      1.53 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      id_grp_payment_type,
      'Other revenue' AS "Метрика",
      COALESCE("Gift cards (Revenue)"::double precision, 0) + COALESCE("Event (revenue)"::double precision, 0) + COALESCE("Other (revenue)"::double precision, 0) AS "Значение",
      1.5 AS "Порядок"
    FROM
      source
    WHERE
      COALESCE("Gift cards (Revenue)"::double precision, 0) + COALESCE("Event (revenue)"::double precision, 0) + COALESCE("Other (revenue)"::double precision, 0) != 0
    UNION ALL
    SELECT
      id_club,
      --id_user,
      ...
      COALESCE("Cash"::double precision, 0) + COALESCE("POS"::double precision, 0) + COALESCE("Online (APP)"::double precision, 0) + COALESCE("Gift cards (Revenue)"::double precision, 0) + COALESCE("Event (revenue)"::double precision, 0) + COALESCE("Other (revenue)"::double precision, 0) AS "Значение",
      1.1 AS "Порядок"
    FROM
      source
    WHERE
      COALESCE("Cash"::double precision, 0) + COALESCE("POS"::double precision, 0) + COALESCE("Online (APP)"::double precision, 0) + COALESCE("Gift cards (Revenue)"::double precision, 0) + COALESCE("Event (revenue)"::double precision, 0) + COALESCE("Other (revenue)"::double precision, 0) != 0
    UNION ALL
    SELECT
      id_club,
      --id_user,
      ...
      "Team bonuses (expense)"::double precision AS "Значение",
      2.15 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Manager salaries (expense)"::double precision AS "Значение",
      2.12 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Staff salaries (expense)"::double precision AS "Значение",
      2.11 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Internet (expense)"::double precision AS "Значение",
      2.14 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Utilities (expense)"::double precision AS "Значение",
      2.13 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Marketing and advertising (expense)"::double precision AS "Значение",
      2.16 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Bar expenses (expense)"::double precision AS "Значение",
      2.17 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Cleaning (expense)"::double precision AS "Значение",
      2.18 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "CRM and digital payments (expense)"::double precision AS "Значение",
      2.19 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Banking services (expense)"::double precision AS "Значение",
      2.191 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Accounting services (expense)"::double precision AS "Значение",
      2.192 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Equipment (expense)"::double precision AS "Значение",
      2.193 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Repair (expense)"::double precision AS "Значение",
      2.194 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Household expenses (expense)"::double precision AS "Значение",
      2.195 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Tournament prize pool (expense)"::double precision AS "Значение",
      2.196 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Transportation expenses (expense)"::double precision AS "Значение",
      2.197 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Rent (expense)"::double precision AS "Значение",
      2.198 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Legal expenses (expense)"::double precision AS "Значение",
      2.199 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Other expenses (expense)"::double precision AS "Значение",
      2.1991 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Miscellaneous expenses (expense)"::double precision AS "Значение",
      2.1992 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "VAT (expense)"::double precision AS "Значение",
      2.1993 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Taxes and fees (expense)"::double precision AS "Значение",
      2.1994 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Event payments in cash (expense)"::double precision AS "Значение",
      2.1995 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      "Payments for other income (expense)"::double precision AS "Значение",
      2.1996 AS "Порядок"
    FROM
      source
    WHERE
    ...
    SELECT
      ...
      COALESCE("Team bonuses (expense)"::double precision, 0) + COALESCE("Manager salaries (expense)"::double precision, 0) + COALESCE("Staff salaries (expense)"::double precision, 0) + COALESCE("Internet (expense)"::double precision, 0) + COALESCE("Utilities (expense)"::double precision, 0) + COALESCE("Marketing and advertising (expense)"::double precision, 0) + COALESCE("Bar expenses (expense)"::double precision, 0) + COALESCE("Cleaning (expense)"::double precision, 0) + COALESCE("CRM and digital payments (expense)"::double precision, 0) + COALESCE("Banking services (expense)"::double precision, 0) + COALESCE("Accounting services (expense)"::double precision, 0) + COALESCE("Equipment (expense)"::double precision, 0) + COALESCE("Repair (expense)"::double precision, 0) + COALESCE("Household expenses (expense)"::double precision, 0) + COALESCE("Tournament prize pool (expense)"::double precision, 0) + COALESCE("Transportation expenses (expense)"::double precision, 0) + COALESCE("Rent (expense)"::double precision, 0) + COALESCE("Legal expenses (expense)"::double precision, 0) + COALESCE("Other expenses (expense)"::double precision, 0) + COALESCE("Miscellaneous expenses (expense)"::double precision, 0) + COALESCE("VAT (expense)"::double precision, 0) + COALESCE("Taxes and fees (expense)"::double precision, 0) + COALESCE("Event payments in cash (expense)"::double precision, 0) + COALESCE("Payments for other income (expense)"::double precision, 0) AS "Значение",
      2.1 AS "Порядок"
    FROM
      source
    WHERE
      COALESCE("Team bonuses (expense)"::double precision, 0) + COALESCE("Manager salaries (expense)"::double precision, 0) + COALESCE("Staff salaries (expense)"::double precision, 0) + COALESCE("Internet (expense)"::double precision, 0) + COALESCE("Utilities (expense)"::double precision, 0) + COALESCE("Marketing and advertising (expense)"::double precision, 0) + COALESCE("Bar expenses (expense)"::double precision, 0) + COALESCE("Cleaning (expense)"::double precision, 0) + COALESCE("CRM and digital payments (expense)"::double precision, 0) + COALESCE("Banking services (expense)"::double precision, 0) + COALESCE("Accounting services (expense)"::double precision, 0) + COALESCE("Equipment (expense)"::double precision, 0) + COALESCE("Repair (expense)"::double precision, 0) + COALESCE("Household expenses (expense)"::double precision, 0) + COALESCE("Tournament prize pool (expense)"::double precision, 0) + COALESCE("Transportation expenses (expense)"::double precision, 0) + COALESCE("Rent (expense)"::double precision, 0) + COALESCE("Legal expenses (expense)"::double precision, 0) + COALESCE("Other expenses (expense)"::double precision, 0) + COALESCE("Miscellaneous expenses (expense)"::double precision, 0) + COALESCE("VAT (expense)"::double precision, 0) + COALESCE("Taxes and fees (expense)"::double precision, 0) + COALESCE("Event payments in cash (expense)"::double precision, 0) + COALESCE("Payments for other income (expense)"::double precision, 0) != 0
    UNION ALL
    SELECT
      id_club,
      --id_user,
      ...
      (
        (
          COALESCE("Cash"::double precision, 0) + COALESCE("POS"::double precision, 0) + COALESCE("Online (APP)"::double precision, 0) + COALESCE("Gift cards (Revenue)"::double precision, 0) + COALESCE("Event (revenue)"::double precision, 0) + COALESCE("Other (revenue)"::double precision, 0)
        ) - (
          COALESCE("Team bonuses (expense)"::double precision, 0) + COALESCE("Manager salaries (expense)"::double precision, 0) + COALESCE("Staff salaries (expense)"::double precision, 0) + COALESCE("Internet (expense)"::double precision, 0) + COALESCE("Utilities (expense)"::double precision, 0) + COALESCE("Marketing and advertising (expense)"::double precision, 0) + COALESCE("Bar expenses (expense)"::double precision, 0) + COALESCE("Cleaning (expense)"::double precision, 0) + COALESCE("CRM and digital payments (expense)"::double precision, 0) + COALESCE("Banking services (expense)"::double precision, 0) + COALESCE("Accounting services (expense)"::double precision, 0) + COALESCE("Equipment (expense)"::double precision, 0) + COALESCE("Repair (expense)"::double precision, 0) + COALESCE("Household expenses (expense)"::double precision, 0) + COALESCE("Tournament prize pool (expense)"::double precision, 0) + COALESCE("Transportation expenses (expense)"::double precision, 0) + COALESCE("Rent (expense)"::double precision, 0) + COALESCE("Legal expenses (expense)"::double precision, 0) + COALESCE("Other expenses (expense)"::double precision, 0) + COALESCE("Miscellaneous expenses (expense)"::double precision, 0) + COALESCE("VAT (expense)"::double precision, 0) + COALESCE("Taxes and fees (expense)"::double precision, 0) + COALESCE("Event payments in cash (expense)"::double precision, 0) + COALESCE("Payments for other income (expense)"::double precision, 0)
        )
      ) AS "Значение",
      3.1 AS "Порядок"
    FROM
