...
@dag(
    dag_id="etl_full_copy_all_databases",
    start_date=datetime(2024, 1, 1),
    schedule="@hourly",
    catchup=False,
    tags=["etl", "postgres", "replication", "full_copy"],
)
def etl_full_copy_all_databases():
    ...
    copy_all_tables("pg_source1", "pg_dwh-en")
    copy_all_tables("pg_source2", "pg_dwh-en")


dag = etl_full_copy_all_databases()
